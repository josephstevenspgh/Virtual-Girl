package{
	...
	public class SlopeTest extends VGMap{
		
		//Maps
		[Embed(source="Data/SlopeTestmap001.txm",				mimeType="application/octet-stream")] protected var SlopeTest_Data:Class;
		
		[Embed(source="Data/SlopeTesttiles.png")] 				protected var STiles:Class;
		
		public function SlopeTest(NX:Number = -1, NY:Number = -1){
			InitX = NX;
			InitY = NY;
		}
		...
		override protected function initGame():void{
			...
			//Load Map
			LevelTileMap	= new FlxTilemapExt();
			LevelTileMap.loadMap(new SlopeTest_Data, STiles, 16, 16, 0, 0, 1, 1);
