package org.flixel
{
	...
	public class FlxObject extends FlxBasic
	{
		...
		public var y:Number;
		/**
		 * Hacking up collision so I can walk over shit yo 8)
		 */
		public var isShort:Boolean = false;
		/**
...
//						FlxG.log("X1 Overlap: "+overlap);
						if((overlap > maxOverlap) || !(Object1.allowCollisions & RIGHT) || !(Object2.allowCollisions & LEFT)){
							overlap = 0;
						}else{
							if(overlap <= 4 && (Object1.isShort || Object2.isShort)){
								Object1.y -= (Object1.y + Object1.height) - Object2.y;
								overlap = 0;	
							}else{
